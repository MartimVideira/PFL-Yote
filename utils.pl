...
%finds max element
findMax([[V,C,M]],[V,C,M]):-!.
findMax([[V,_C,_M]|XS], [VC,CC,MC]):- findMax(XS, [VC,CC,MC]), VC >= V.
findMax([[V,C,M]|XS],[V,C,M]):- findMax(XS, [VC,_CC,_MM]), V >  VC.

%finds min element
findMin([[V,C,M]],[V,C,M]) :- !.
findMin([[V,_C,_M]|XS], [VC,CC,MC]):- findMin(XS, [VC,CC,MC]), VC < V.
findMin([[V,C,M]|XS], [V,C,M]):- findMin(XS, [VC,_CC,_MM]), V =<  VC.